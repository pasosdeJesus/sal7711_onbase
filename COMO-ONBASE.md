...
* Tareas
* Script
* Seguir wizard eligiendo script con tablas.
...
La información extraida puede convertirse a SQL para insertar en otra base. 
Por ejemplo la tabla 108 (nombres de departamento para el ejemplo visto):
```
...
```
Puede tener inserciones generables con:
```
...
```
Y la tabla que relaciona artículos con departamentos:
```
...
```
Puede tener insercioens generables con:
```
